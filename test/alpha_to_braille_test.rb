...
class AlphaToBrailleTest < Minitest::Test
  ...
  def test_slice_string_slices_string
    ...
    assert_equal expected_1, writer.alpha_by_80(a)
    assert_equal expected_2, writer.alpha_by_80(b)
    assert_equal expected_3, writer.alpha_by_80(c)
  end
  ...
  def test_braille_slices_returns_top_mid_and_bottom_arrays_translated
    ...
    assert_equal expected_1, writer.top_line
    assert_equal expected_2, writer.middle_line
    assert_equal expected_3, writer.bottom_line
  end
...
"
    assert_equal expected, writer.blend_braille
  end
