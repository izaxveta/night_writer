      ...
      BRAILLE = {
        ...
        "'" => ["..","..","0."], "," => ["..","0.",".."], "-" => ["..","..","00"],
        "." => ["..","00",".0"], "?" => ["..","0.","00"], " " => ["..","..",".."],
        "1" => [".00.",".0..","00.."], "2" => [".00.",".00.","00.."], "3" => [".000",".0..","00.."],
        "4" => [".000",".0.0","00.."], "5" => [".00.",".0.0","00.."], "6" => [".000",".00.","00.."],
        "7" => [".000",".000","00.."], "8" => [".00.",".000","00.."], "9" => [".0.0",".00.","00.."],
        "0" => [".0.0",".000","00.."],':shift' => ["..", "..", ".0"]
      }
      ...
      ALPHA = {
        ...
        ["00",".0","00"] => "y", ["0.",".0","00"] => "z", ["..","00","0."] => "!",
        ["..","..","0."] => "'", ["..","0.",".."] => ",", ["..","..","00"] => "-",
        ["..","00",".0"] => ".", ["..","0.","00"] => "?", ["..","..",".."] => " ",
        [".00.",".0..","00.."] => "1", [".00.",".00.","00.."] => "2", [".000",".0..","00.."] => "3",
        [".000",".0.0","00.."] => "4", [".00.",".0.0","00.."] => "5", [".000",".00.","00.."] => "6",
        [".000",".000","00.."] => "7", [".00.",".000","00.."] => "8", [".0.0",".00.","00.."] => "9",
        [".0.0",".000","00.."] => "0", ["..", "..", ".0"] => :shift
      }
